## source(file.path(dbpath, "markdown_files", "OECD", "mission_presentation", "presentation_bi_forum", "create_presentation_slidify.R"))
...
path <- file.path(dbpath, "markdown_files", "OECD", "mission_presentation", "presentation_bi_forum")
setwd(path)
